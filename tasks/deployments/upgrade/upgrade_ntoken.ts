...
import {deployGenericNTokenImpl, deployGenericPTokenImpl} from "../../../helpers/contracts-deployments";
import {
...
export const upgradeNToken = async () => {
    ...
    const nTokenImplementation = await deployGenericNTokenImpl(poolAddress, false, verify);
