import {
    deployFlashClaimRegistry, deployMockAirdropProject,
} from "../../../../helpers/contracts-deployments";
import {
    getPoolAddressesProvider, getProtocolDataProvider,
...
export const step_18 = async (verify = false) => {
    try {
        ...
        await deployFlashClaimRegistry(
            poolAddress,
            verify
        );
        ...
        await deployMockAirdropProject(
            baycAddress,
            verify
        );
    } catch (error) {
