import {getACLManager, getPoolAddressesProvider, getPoolAddressesProviderRegistry} from "../../../../helpers/contracts-getters";
...
export const step_19 = async () => {
  try {
    ...
    await waitForTx(await addressesProviderRegistry.transferOwnership(paraSpaceAdmin))
  } catch (error) {
    console.error(error);
    process.exit(1);
  }
